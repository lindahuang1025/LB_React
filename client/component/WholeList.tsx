...
const WholeList = (props: dataType) => {
    const { wholeGoups, isActiveWholeList, settings, onClickWholeList } = props;
    ...
    return (<>
        {wholeGoups.map((group, groupIdx) => {
            ...
            return (
                <div key={groupIdx}>
                    {settings.showSymbolGroup && <h3 className=" text-xl hover:cursor-pointer flex justify-between justify-items-center"
                    ...
                    <div className={settings.showSymbolGroup ? "" : "mt-[15px]"}>
