...
const SymbolDetail = ({ wholeItem, settings }: { wholeItem: WholelistsContract, settings: Settings }) => {
    let { Symbol,
        CompanyName,
        Price,
        PriceChange,
    ...
    let priceChgFormat = numberFormat(PriceChange),
        ...
        var borderClass=settings.showBanner?'':' border border-[#ddd] rounded border-t-8 ';
    return (<div className=" mt-[70px]">
        {settings.showBanner && <div className="bg-primary h-[52px] pt-[10px]  text-white">
        ...
        <div className={' shadow-md  bg-white  border-t-primary px-5 pt-[18px] pb-[15px]' +borderClass}>
