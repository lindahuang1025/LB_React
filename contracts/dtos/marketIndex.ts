import { MarketIndicesInterface, MarketIndexInterface, EtfIndexInterface } from "@/contracts/interfaces"
import { MarketStatus } from "@/contracts/enumerates"

class MarketIndex implements MarketIndexInterface {
  Symbol: string;
...
class EtfIndex implements EtfIndexInterface {
  Symbol: string;
  Name: string;
  Price: string;
  PriceChange: string;
...
export class MarketIndicesDto implements MarketIndicesInterface {
